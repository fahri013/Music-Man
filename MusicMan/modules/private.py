        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "🛠 Follow Instagramku 🛠", url=f"https://{SOURCE_CODE}")
                ]
            ]
        ),
...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '💬 Channel Kutipan', url=f"https://t.me/{UPDATES_CHANNEL}"),
             InlineKeyboardButton(text = '⛑ Group Mutualan', url=f"https://t.me/{SUPPORT_GROUP}")],
            [InlineKeyboardButton(text = '🛠 INSTAGRAM 🛠', url=f"https://{SOURCE_CODE}")],
